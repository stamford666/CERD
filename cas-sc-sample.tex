...
\begin{itemize}
    ...
    \item Matched three-seed experiments on ADNI and ABCD evaluate predictive performance, component necessity, and modality dependence under heterogeneous missingness. CERD leads all ADNI metrics and the ABCD accuracy and macro-AUROC, while controlled removals quantify how each architectural stage and input source changes the decision.
\end{itemize}
...
\noindent\textbf{ABCD.}
The ABCD Study characterizes adolescent brain, cognitive, behavioral, and health development~\cite{garavan2018abcd}. We derive three mutually exclusive states from the baseline parent K-SADS ADHD assessment: (i)~a strict low-symptom comparator with no current, past, partial-remission, or unspecified ADHD and at most three current symptoms in either nine-item domain; (ii)~past full ADHD or partial remission, without current full or unspecified ADHD; and (iii)~current full ADHD with at least six current symptoms in either domain. The family-disjoint cohort contains \(3{,}527\) participants, split into \(2{,}512/506/509\) for training/validation/testing. The corresponding class counts are \(1254/654/604\), \(272/115/119\), and \(250/119/140\).

ABCD predictors form four model modalities. Imaging (785 variables) concatenates rs-fMRI network connectivity and regional variance, regional contrast estimates from SST, emotional n-back, and MID task-fMRI, regional T1-weighted gray matter intensity, and DTI-derived FA. Genetics comprises 1,183 directly encoded SNP dosages retained after training-set missingness, minor allele frequency, and LD pruning within 14 prespecified candidate-gene windows; no PRS or ancestry components are used. The cognition and health group contains 90 NIH Toolbox, WISC, Little Man, RAVLT, sleep, and physical-activity variables. The behavior and environment group materializes 221 non-ADHD behavioral, family, neighborhood, socioeconomic, and address-linked exposure variables, of which 219 survive training-only screening.
...
\midrule
Training & 409/1480 (27.64) & 377/2512 (15.01) \\
Validation & 91/318 (28.62) & 76/506 (15.02) \\
Testing & 99/318 (31.13) & 76/509 (14.93) \\
\bottomrule
\end{tabular*}
\end{minipage}
\end{center}
...
\midrule
Flex-MoE
& 60.84$\pm$1.67 & 52.52$\pm$1.11 & 73.96$\pm$0.88 \\
I$^2$MoE
& 58.28$\pm$1.50 & 51.86$\pm$0.65 & 74.83$\pm$0.89 \\
MoE++-corrected
& 58.22$\pm$1.39 & 49.81$\pm$0.88 & 74.20$\pm$0.99 \\
AnyMod
& 60.77$\pm$1.39 & \textbf{53.17$\pm$1.19} & 73.64$\pm$1.10 \\
AGDiC-inspired
& 60.64$\pm$1.59 & 53.16$\pm$1.12 & 72.69$\pm$0.44 \\
ACADiff-inspired
& 56.91$\pm$0.45 & 47.48$\pm$1.01 & 69.75$\pm$0.76 \\
\textbf{CERD (Ours)}
& \textbf{61.43$\pm$0.30} & 51.14$\pm$0.72 & \textbf{74.88$\pm$0.34} \\
\bottomrule
\end{tabular*}
\end{table}

On ABCD, CERD gives the highest mean accuracy and macro-AUROC in Table~\ref{tab:abcd_results}, by \(0.59\) and \(0.04\) points over the strongest corresponding baselines. AnyMod gives the highest macro-F1, exceeding CERD by \(2.03\) points. The two views expose the remaining difficulty rather than contradicting one another: CERD separates the outer clinical states sufficiently to improve overall decisions and ranking, whereas errors concentrated in the heterogeneous past/remission group reduce equal-class F1.
...
ABCD & Complete & 433 & 61.74$\pm$0.35 & 50.50$\pm$1.26 & 75.52$\pm$0.38 \\
 & Incomplete & 76 & 59.65$\pm$0.76 & 53.51$\pm$1.30 & 71.24$\pm$1.02 \\
\bottomrule
\end{tabular*}
\end{table}

Table~\ref{tab:availability_strata} shows that CERD remains operational for incomplete participants in both cohorts. ADNI ranking performance is retained despite missing sources, whereas ABCD exhibits a larger AUROC reduction than accuracy reduction. Because the strata contain different participants, they describe deployment conditions rather than a causal effect of missingness; the matched within-participant removals in Section~\ref{sec:decision_analysis} isolate modality dependence directly.
...
\midrule
w/o Conditional Completion & 63.73$\pm$0.79 & 62.82$\pm$1.58 & 79.48$\pm$0.41 & 60.64$\pm$1.97 & 51.52$\pm$2.19 & 74.23$\pm$1.22 \\
w/o Provenance Embeddings & 63.52$\pm$1.57 & 63.41$\pm$1.95 & 80.50$\pm$0.70 & 60.90$\pm$1.53 & 50.67$\pm$1.13 & 74.75$\pm$0.50 \\
w/o Sparse MoE (Dense FFN) & 64.99$\pm$1.19 & 65.27$\pm$1.12 & 81.59$\pm$0.74 & 60.38$\pm$1.15 & 52.70$\pm$0.95 & 75.36$\pm$0.51 \\
w/o Multigranular Decomposition & 62.47$\pm$0.79 & 62.36$\pm$1.00 & 79.72$\pm$1.32 & 59.99$\pm$1.45 & 51.21$\pm$1.85 & 74.04$\pm$0.48 \\
w/o Reliability-aware Weights & 64.05$\pm$1.49 & 63.88$\pm$0.21 & 80.95$\pm$0.19 & 61.95$\pm$1.50 & 52.46$\pm$1.48 & 74.99$\pm$0.76 \\
\textbf{Full CERD} & \textbf{65.72$\pm$1.09} & \textbf{64.56$\pm$2.09} & \textbf{81.07$\pm$0.55} & \textbf{61.43$\pm$0.30} & \textbf{51.14$\pm$0.72} & \textbf{74.88$\pm$0.34} \\
\bottomrule
\end{tabular*}
\end{table*}

\noindent\textbf{Ablation results.}
Table~\ref{tab:component_ablation} shows that conditional completion, provenance, and multigranular decomposition produce consistent accuracy and AUROC gains on both cohorts. Removing the decomposition causes the largest ADNI accuracy loss (3.25 points), indicating that modality- and pair-anchored readouts recover decisions not retained by a single global head. Provenance is also consequential: its removal lowers all six dataset--metric combinations, with the smallest change occurring in ABCD AUROC. Replacing the sparse experts with a dense FFN lowers accuracy by 0.73 points on ADNI and 1.05 points on ABCD, although the dense block trades this decision-rate advantage for higher macro-F1 and AUROC in several cells. Reliability-aware weighting improves every ADNI metric; on ABCD, uniform weighting has a slightly higher mean but substantially larger accuracy variance. No reduced variant dominates full CERD across both endpoints, while the complete model provides the strongest cross-cohort accuracy with the lowest ABCD seed dispersion.
...
\midrule
ABCD & Imaging & 25.23$\pm$1.13 & 23.33$\pm$20.00 & 25.30$\pm$18.58 & 6.55$\pm$6.49 \\
 & Genetics & 23.97$\pm$0.65 & 25.64$\pm$15.40 & 30.69$\pm$8.52 & 4.78$\pm$4.87 \\
 & Cog./health & 26.35$\pm$0.91 & 6.00$\pm$5.60 & 16.69$\pm$12.15 & $-$0.40$\pm$0.54 \\
 & Behav./env. & 24.45$\pm$1.08 & 10.70$\pm$0.35 & 27.97$\pm$1.26 & 19.07$\pm$1.29 \\
\bottomrule
\end{tabular*}
\end{table}
...
Table~\ref{tab:modality_contribution} and Fig.~\ref{fig:two_dataset_modality_drop} reveal endpoint-specific dependence within a non-collapsed allocation profile. ADNI is most sensitive to MRI and biospecimen removal, consistent with complementary structural and molecular evidence for neurodegenerative status. ABCD shows a different organization: genetics produces the largest mean accuracy and macro-F1 decreases, while behavior and environment produce the largest AUROC decrease. Thus, the directly encoded QC/LD-pruned SNPs contribute materially even without PRS or ancestry components, and contextual exposure variables chiefly support class ranking. The allocation shares remain between approximately 22\% and 28\% across both datasets, indicating that CERD preserves multiple active evidence routes rather than reducing the decision to a single dominant source.

\section{Discussion}
\label{sec:discussion}

\noindent\textbf{Coupling completion with controlled trust.}
CERD leads all three ADNI metrics and the ABCD accuracy and macro-AUROC while operating on naturally and synthetically incomplete inputs. Conditional queries recover target-specific evidence, provenance exposes its origin to attention and routing, and reliability determines its decision influence. The paired component controls support this sequence: removing either completion or provenance lowers accuracy and AUROC on both cohorts, so recovered content and evidence origin contribute distinct information.
...
The modality audit locates this evidence at the endpoint level. ADNI depends most on structural MRI and biospecimens; ABCD accuracy is most sensitive to genetics and imaging, whereas its ranking is most sensitive to behavior/environment. Normalized allocations nevertheless remain distributed across all four sources. CERD thus preserves complementary evidence routes while allowing biological endpoint to determine their predictive dependence.

\section{Conclusion}

CERD combines conditional token recovery, sparse provenance-aware expert fusion, and reliability-based evidence decomposition. It gives the strongest ADNI result across all reported metrics and the highest ABCD accuracy and macro-AUROC among matched baselines. Across cohorts, controls isolate completion, provenance, multigranular readout, and endpoint-specific modality dependence. Branch probabilities and normalized weights directly compose both the prediction and its evidence allocation.

#!/usr/bin/env python3
"""Build the strict ABCD current-ADHD binary dataset.

The endpoint contrasts a low-symptom participant with no current or historical
ADHD diagnosis against current full ADHD with a DSM-consistent >=6-symptom
domain.  Historical/remitted, unspecified, and symptom-only cases are
excluded.
...
def main() -> None:
    ...
    parser.add_argument("--endpoint", choices=("current_binary",), default="current_binary")
